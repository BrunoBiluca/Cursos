...
namespace DotNetDesignPatternDemos.Creational.AbstractFactory {
  ...
  public class HotDrinkMachine {
    ...
    public IHotDrink MakeDrink() {
      ...
      // Utiliza Reflexion para instancia o tipo de HotDrink será fabricado
  ...
  class Program {
    static void Main(string[] args) {
      var machine = new HotDrinkMachine(); // Factory
      //var drink = machine.MakeDrink(HotDrinkMachine.AvailableDrink.Tea, 300);
      //drink.Consume();

      IHotDrink drink = machine.MakeDrink(); // Retorna uma instância criado por reflexão a partir da escolha do client
      drink.Consume();
    }
  }
}
